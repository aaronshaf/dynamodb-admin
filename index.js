...
if (runningFromCli && process.env.NODE_ENV === 'production') {
  console.error('\x1b[31mDo not run this in production!') // red
  process.exit(1)
}

function buildServer(dynamodb, docClient) {
  dynamodb = dynamodb || new (require('aws-sdk').DynamoDB)()
  docClient = docClient || new (require('aws-sdk').DynamoDB.DocumentClient)()
...
if (runningFromCli) {
  ...
  require('aws-sdk').config.update(awsConfig);
