    ...
    asyncMiddleware((req, res) => {
      ...
      if(req.body.SecondaryIndexes) {
        ...
        req.body.SecondaryIndexes.forEach(secondaryIndex => {
          ...
          if(isAttributeAlreadyCreated(attributeDefinitions, secondaryIndex.HashAttributeName)) {
            attributeDefinitions.push({
              AttributeName: secondaryIndex.HashAttributeName,
          ...
          if(secondaryIndex.RangeAttributeName) {
            if(isAttributeAlreadyCreated(attributeDefinitions, secondaryIndex.RangeAttributeName)) {
              attributeDefinitions.push({
...
function isAttributeAlreadyCreated(attributeDefinitions, attributeName) {
